const DUAL_SHOT_PROJECTILE_SPEED_PARITY = 2;
export function resolveDualShotProjectileConfigs(snapshot) {
    if (snapshot.levelId !== 3) {
        return [];
    }
    const diagonalVelocity = DUAL_SHOT_PROJECTILE_SPEED_PARITY / Math.sqrt(2);
...
//# sourceMappingURL=dualShotPattern.js.map
...
import { LEVEL4_TROJAN_DAMAGE, LEVEL4_TROJAN_HEALTH, LEVEL4_TROJAN_SCORE_VALUE, } from '../scenes/level4TrojanCombat.js';
export default class TrojanPrefab extends Phaser.GameObjects.Image {
    static TEXTURE_KEY = 'enemy-trojan';
    enemyId;
    velocityX;
    velocityY;
    currentHealth;
...
//# sourceMappingURL=TrojanPrefab.js.map
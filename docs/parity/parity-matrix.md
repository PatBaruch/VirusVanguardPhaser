...
| Player movement | Legacy reference only | In progress | `docs/handoffs/2026-02-11-pr-009-player-prefab-facing-direction-states.md` | PR-009 adds player prefab and eight-direction facing-state sprite parity; movement vectors and normalization remain planned in PR-010. |
| Level traversal | Legacy reference only | In progress | `docs/handoffs/2026-02-11-pr-008-level0-scene-visuals-dialogue-progression.md`, `docs/handoffs/2026-02-11-pr-009-player-prefab-facing-direction-states.md` | Level0 visual/dialogue shell and player prefab parity are in place; movement, bounds, and transition rules remain planned in PR-010 to PR-017. |

...
| Player movement | Legacy reference only | Not started | - | Planned in PR-009 and PR-010. |
| Level traversal | Legacy reference only | Not started | - | Planned in PR-008 and PR-011 to PR-017. |

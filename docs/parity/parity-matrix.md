...
| Player movement | Baseline established | In progress | `docs/handoffs/2026-02-11-pr-009-player-prefab-facing-direction-states.md`, `docs/handoffs/2026-02-11-pr-010-8-direction-movement-diagonal-normalization.md` | PR-010 adds walkable WASD movement, diagonal normalization, and legacy key-precedence behavior; bounds and transitions remain pending. |
| Level traversal | Legacy reference only | In progress | `docs/handoffs/2026-02-11-pr-008-level0-scene-visuals-dialogue-progression.md`, `docs/handoffs/2026-02-11-pr-009-player-prefab-facing-direction-states.md`, `docs/handoffs/2026-02-11-pr-010-8-direction-movement-diagonal-normalization.md` | Level0 visual/dialogue shell and walkable movement parity are in place; bounds and transition rules remain planned in PR-011 to PR-017. |

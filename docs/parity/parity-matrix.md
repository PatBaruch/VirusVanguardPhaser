...
| Level traversal | Legacy reference only | In progress | `docs/handoffs/2026-02-11-pr-008-level0-scene-visuals-dialogue-progression.md`, `docs/handoffs/2026-02-11-pr-009-player-prefab-facing-direction-states.md`, `docs/handoffs/2026-02-11-pr-010-8-direction-movement-diagonal-normalization.md`, `docs/handoffs/2026-02-11-pr-011-level0-bounds-transition-trigger.md`, `docs/handoffs/2026-02-11-pr-012-level1-shell-background-dialogue-bounds-transition-zone.md` | Level0 shell and transition into Level1 are in place, and Level1 now has dialogue/bounds/transition-zone shell parity; Level2 to Level5 scene shells and transition-rule predicate wiring remain planned in PR-013 to PR-017. |

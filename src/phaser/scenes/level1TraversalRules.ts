...
export interface Level1TraversalSnapshot {
  canvasHeight: number;
  canvasWidth: number;
  playerHeight: number;
  playerWidth: number;
...
function resolveLevel1Bounds(snapshot: Level1TraversalSnapshot): {
  maxX: number;
  maxY: number;
  minX: number;
  minY: number;
...
export function canMoveWithinLevel1Bounds(
  snapshot: Level1TraversalSnapshot,
...
export function isLevel1ToLevel2TransitionTriggered(snapshot: Level1TraversalSnapshot): boolean {
